...
Yet another Golang implementation of ICalendar Standard


## Way to setup IKalendar
...
### Via Icalendar Struct

```go
import 	"github.com/minoplhy/ikalendar/internal/icalendar"
...
* On a nested setup(Like #2), the validation error will not be displayed. But the error value will not be added.
* Not all functionality are implemented Yet!

## TODO

* support others `VCALENDAR` `SUBCAL`
